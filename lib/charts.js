...
async function renderChartJs(
  ...
  if (version.startsWith('3') || version.startsWith('4')) {
    ...
    if (chart.type === 'sankey') {
      // chartjs-chart-sankey requires 'chart.js' and 'chart.js/helpers', but this project
      // aliases v3/v4. Swap the require so the plugin registers against the correct version.
      const Module = require('module');
      const origResolveFilename = Module._resolveFilename;
      const versionPrefix = version.startsWith('4') ? 'chart.js-v4' : 'chart.js-v3';
      Module._resolveFilename = function(request, parent, ...args) {
        if (request === 'chart.js') {
          return origResolveFilename.call(this, versionPrefix, parent, ...args);
        }
        if (request === 'chart.js/helpers') {
          return origResolveFilename.call(this, `${versionPrefix}/helpers`, parent, ...args);
        }
